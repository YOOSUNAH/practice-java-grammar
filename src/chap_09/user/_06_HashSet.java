...
public class _06_HashSet {
    public static void main(String[] args) {
        ...
        System.out.println("총 구매 상품 수 : " + set.size()); // 중복 허용하지 않음

        for (String s :set) {
            System.out.println(s); // 순서 뒤죽박죽 나옴
        }
        System.out.println("--------------------");
        ...
        // 세트는 중복 허용 X, 순서 보장 X _ 순서 보장을 원하면 그냥 HashSet 이 아닌 LinkedHashSet을 쓰면 됨
